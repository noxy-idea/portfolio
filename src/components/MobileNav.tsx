      ...
      >
        ...
        >
          ...
          <div className="bg-gray-50 py-6 flex justify-center gap-12 border-t border-gray-100">
            {/* GitHub */}
            <a href="https://github.com/" target="_blank" rel="noopener noreferrer" className="text-black hover:scale-110 transition p-1">
            ...
            {/* X (Twitter) */}
            <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" className="text-black hover:scale-110 transition p-1">
              <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
